...
I'd like to discuss my project requirements and proceed with the next steps.`;
  ...
  const getMaterialInfo = () => {
    if (data.materialSource === 'luxone') {
      ...
      return data.brandSupplier || 'Other Material';
    }
    return 'Material TBC';
  };
  ...
  const calculateEstimatedArea = () => {
    ...
    const totalAreaMm2 = pieces.reduce((total, piece) => {
    ...
    return Math.round(totalAreaMm2 / 92903.04);
  };
              ...
              <div className="bg-gray-50 rounded-lg p-4 mb-6">
                ...
                <div className="grid md:grid-cols-2 gap-4 text-sm">
                  <div>
                    ...
                    <p className="text-gray-900 mb-3">{data.materialColor || data.luxoneOthersColorName || 'TBC'}</p>
                    
                    <p className="text-gray-600 mb-1"><strong>Layout:</strong></p>
                    <p className="text-gray-900">{getLayoutText(data.worktopLayout)}</p>
                  </div>
                  <div>
                    ...
                    <p className="text-gray-600 mb-1"><strong>Sinks Selected:</strong></p>
                    <p className="text-gray-900">{getSinkCount()}</p>
                  </div>
                </div>
              </div>
